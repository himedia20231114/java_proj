	...
	public static void main(String[] args) {
		/*
		 1. 자식 객체를 생성후 
		 		...
		 		Banana ("바나나", 44, 6000) 	Fruit 타입으로 정의
		 		StrawBerry ("딸기",55, 7000)	Fruit 타입으로 정의
		 		
		 2. ArrayList 객체 3개를 저장 
		 3. For문으로 ArrayList의 객체를 끄집어 내서 totalPrice() 호출시
		 4.    출력 : " 000 의 전제 가격은 : 000 입니다. 	
		 	
		 자식 객체를 생성하면서 부모 타입으로 지정하면, 배열이나 컬렉션에 동일한 타입으로 저장 가능
