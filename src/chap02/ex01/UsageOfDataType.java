...
public class UsageOfDataType {  // 클래스 영역 
	public static void main(String[] args) {  //메인 메소드 
		// 변수 : 한번 선언후 변수의 값을 다른 값을 할당 할 수 있다. , 소문자로 시작해서 캐멀캐이스 이름 작성 
		// 상수 : 변수 선언 앞에 final 키가 등록됨, 상수명은 대문자로만 지정, 한번 값을 할당하면 그 값을 수정할 수 없다. 
		
		/* 자료형 : 변수/상수를 정의할때 반드시 자료형 , <<p 60 page>>
...
//		ABC = 300; 		//상수는 새로운 값을 넣으면 오류 발생 
		...
		gg = -9_223_372_036_854_775_808L;	// 리터럴에 L 를 적용 
		hh = 9_223_372_036_854_775_807L;    
		System.out.println(gg);
		System.out.println(hh);
		
		long ii; 
		ii = 5000;  // int 범위 내의 값을 얺을때 L을 명시 하지 않아도됨 
		
		
		//실수 : float , double <== (기본)  
		//float : 4byte (32bit) , 소숫점 7자리까지 정밀도가 유지됨 ,  리터럴뒤에 f, F
		float jj; 
		jj = 3.1488888888888888888F; 		// 리터럴 뒤 F 
		...
		char firstName1 = '\uc7a5' ;  	// 이름 첫자    : 장
		char firstName2 = '\uc6b0' ; 	// 이름 두번째	  : 우
		char lastName = '\ubc15';       // 성          : 박
		
		
		// 출력 내용 : 나의 이름은 박 장우 입니다. 
